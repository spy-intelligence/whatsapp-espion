...
!(function (t, e) {
  ...
  (p.prototype.eventElement = function (e) {
    ...
    (p.prototype.unbind = function (t, e, i) {
      ...
      l.unbind(e, i),
        l.isEmpty &&
          this.eventElements.splice(this.eventElements.indexOf(l), 1);
    }),
  ...
  var e = function (t, e, i, l, r) {
    ...
    !(function (t, e, i, l, r) {
      ...
      e &&
        (u.dispatchEvent(b("ps-scroll-" + a)),
        e < 0
          ? u.dispatchEvent(b("ps-scroll-" + c))
          : 0 < e && u.dispatchEvent(b("ps-scroll-" + h)),
        l && (Y((d = t), (f = a)), X(d, f)));
      var d, f;
      t.reach[a] &&
        (e || r) &&
        u.dispatchEvent(b("ps-" + a + "-reach-" + t.reach[a]));
    })(t, i, n, l, r);
  };
  function g(t) {
  ...
  var W = {
            ...
            (n.settings.suppressScrollX && 0 !== l) ||
              ...
              (function (t, e) {
                ...
                if (0 === e) {
                  ...
                  if (
                    (0 === l && t < 0) ||
                    (l >= n.contentWidth - n.containerWidth && 0 < t)
                  )
                    return !n.settings.wheelPropagation;
                }
                return !0;
        ...
        function t(t) {
          var e,
            ...
            r =
              ...
              (l = -1 * e.deltaY),
              (void 0 !== i && void 0 !== l) ||
                ((i = (-1 * e.wheelDeltaX) / 6), (l = e.wheelDeltaY / 6)),
              e.deltaMode && 1 === e.deltaMode && ((i *= 10), (l *= 10)),
              i != i && l != l && ((i = 0), (l = e.wheelDelta)),
              e.shiftKey ? [-l, -i] : [i, l]),
            n = r[0],
            o = r[1];
          if (
            ...
            b.settings.useBothWheelAxes
              ? b.scrollbarYActive && !b.scrollbarXActive
                ? (o
                    ? (g.scrollTop -= o * b.settings.wheelSpeed)
                    : (g.scrollTop += n * b.settings.wheelSpeed),
                  (p = !0))
                : b.scrollbarXActive &&
                  !b.scrollbarYActive &&
                  (n
                    ? (g.scrollLeft += n * b.settings.wheelSpeed)
                    : (g.scrollLeft -= o * b.settings.wheelSpeed),
                  (p = !0))
              : ((g.scrollTop -= o * b.settings.wheelSpeed),
                (g.scrollLeft += n * b.settings.wheelSpeed)),
              y(b),
              (p =
                ...
                ((s = n),
                (a = o),
                (c = Math.floor(g.scrollTop)),
                (h = 0 === g.scrollTop),
                (u = c + g.offsetHeight === g.scrollHeight),
                (d = 0 === g.scrollLeft),
                (f = g.scrollLeft + g.offsetWidth === g.scrollWidth),
                !(Math.abs(a) > Math.abs(s) ? h || u : d || f) ||
                  !b.settings.wheelPropagation)) &&
                !t.ctrlKey &&
                (t.stopPropagation(), t.preventDefault());
          }
        }
        void 0 !== window.onwheel
          ? b.event.bind(g, "wheel", t)
          : void 0 !== window.onmousewheel && b.event.bind(g, "mousewheel", t);
      },
      touch: function (s) {
        if (w.supportsTouch || w.supportsIePointer) {
          ...
          w.supportsTouch
            ? (s.event.bind(a, "touchstart", t),
              s.event.bind(a, "touchmove", e),
              s.event.bind(a, "touchend", l))
            : w.supportsIePointer &&
              (window.PointerEvent
                ? (s.event.bind(a, "pointerdown", t),
                  s.event.bind(a, "pointermove", e),
                  s.event.bind(a, "pointerup", l))
                : window.MSPointerEvent &&
                  (s.event.bind(a, "MSPointerDown", t),
                  s.event.bind(a, "MSPointerMove", e),
                  s.event.bind(a, "MSPointerUp", l)));
        }
        function d(t, e) {
          ...
          if (p(t)) {
            ...
            0 < o && ((u.x = l / o), (u.y = r / o), (h = n)),
              (function (t, e) {
                ...
                if (r < n) {
                  if (
                    (e < 0 && i === s.contentHeight - s.containerHeight) ||
                    (0 < e && 0 === i)
                  )
                    return 0 === window.scrollY && 0 < e && w.isChrome;
                } else if (
                  n < r &&
                  ((t < 0 && l === s.contentWidth - s.containerWidth) ||
                    (0 < t && 0 === l))
                )
                  return !0;
                return !0;
    ...
    h = function (t, e) {
      ...
      for (var l in ((this.element = t).classList.add(m.main),
      (this.settings = {
      ...
      (this.isRtl = "rtl" === v(t).direction),
        ...
        (this.scrollbarXRail = f(m.element.rail("x"))),
        t.appendChild(this.scrollbarXRail),
        (this.scrollbarX = f(m.element.thumb("x"))),
      ...
      (this.scrollbarXBottom = parseInt(a.bottom, 10)),
        isNaN(this.scrollbarXBottom)
          ? ((this.isScrollbarXUsingBottom = !1),
            (this.scrollbarXTop = g(a.top)))
          : (this.isScrollbarXUsingBottom = !0),
        (this.railBorderXWidth = g(a.borderLeftWidth) + g(a.borderRightWidth)),
        d(this.scrollbarXRail, { display: "block" }),
        (this.railXMarginWidth = g(a.marginLeft) + g(a.marginRight)),
        d(this.scrollbarXRail, { display: "" }),
        (this.railXWidth = null),
        (this.railXRatio = null),
        (this.scrollbarYRail = f(m.element.rail("y"))),
        t.appendChild(this.scrollbarYRail),
        (this.scrollbarY = f(m.element.thumb("y"))),
    ...
    (h.prototype.update = function () {
      this.isAlive &&
        ...
        (this.railXMarginWidth =
          g(v(this.scrollbarXRail).marginLeft) +
          g(v(this.scrollbarXRail).marginRight)),
        (this.railYMarginHeight =
          g(v(this.scrollbarYRail).marginTop) +
          g(v(this.scrollbarYRail).marginBottom)),
